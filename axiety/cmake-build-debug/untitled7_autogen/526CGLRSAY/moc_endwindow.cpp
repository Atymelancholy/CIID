...
struct qt_meta_stringdata_CLASSendwindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSendwindowENDCLASS = QtMocHelpers::stringData(
    "endwindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSendwindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject endwindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSendwindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSendwindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSendwindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *endwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSendwindowENDCLASS.stringdata0))
